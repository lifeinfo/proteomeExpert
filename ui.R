         ...
         mainPanel(
           tabsetPanel(
             ...
             tabPanel(
               ...
               hr(),
               h5("The test protein matrix contains 24 DIA runs. Missing value imputation (using data preprocessing is a simple way) is required in order to use all functions except quality control."),
